...
This folder contains all documentation for the Looters Land project.
...
- **[worldmap-readme.md](archive/worldmap-readme.md)** - Worldmap system implementation (merged into roadmap)
- **[ROADMAP-WORLDMAP-IDEA.md](archive/ROADMAP-WORLDMAP-IDEA.md)** - Original worldmap design ideas
- **[COMPLIANCE_SUMMARY_v0.6.2.md](archive/COMPLIANCE_SUMMARY_v0.6.2.md)** - Coding compliance report (v0.6.2)
- **[CODING_COMPLIANCE_GUIDE.md](archive/CODING_COMPLIANCE_GUIDE.md)** - Old compliance guide (superseded by coding_rules.md)
- **[V0.8.0_COMPLETION_SUMMARY.md](archive/V0.8.0_COMPLETION_SUMMARY.md)** - v0.8.0 completion report
- **[V0.8.0_IMPLEMENTATION_GUIDE.md](archive/V0.8.0_IMPLEMENTATION_GUIDE.md)** - v0.8.0 implementation details
