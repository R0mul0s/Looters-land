...
// Position System (Phase 3)    partyFormation: 'Party Formation',    enemyFormation: 'Enemy Formation',    position: {      front: 'Front',      middle: 'Middle',      back: 'Back',      aggro: 'Aggro',      empty: 'Empty',      bonuses: 'Position Bonuses',      frontBonus: 'Front: +10% Phys Dmg, -10% Defense, 3x Aggro',      middleBonus: 'Middle: Balanced, 2x Aggro',      backBonus: 'Back: +15% Spell Dmg, +10% Defense, 1x Aggro',    },
  ...
  worldmap: {
    ...
    observationTowerAlreadyUsed: 'You have already used this Observation Tower.',
    observationTowerRevealed: 'The Observation Tower reveals a vast area! {{tilesRevealed}} tiles discovered.',
    healingWellTitle: 'Healing Well',
    healingWellDiscovered: 'You have discovered a mystical healing well!',
    healingWellWillRestore: 'This well will restore {{percent}}% of HP to your entire active party.',
    healingWellAlreadyUsed: 'This healing well has already been used today. Come back tomorrow!',
    healingWellActivePartyStatus: 'Active Party Status:',
    healingWellDailyWarning: '⚠️ This healing well can only be used once per day.',
    healingWellButtonHeal: '💚 Heal Party',
    healingWellButtonCancel: 'Cancel',
    encounterComingSoon: 'Encounter system coming soon!',
    enchantSuccess: '✨ {{message}}\nSuccess rate was {{chance}}%',
  ...
  updates: {
    ...
    v2_3_6: {
      technical: {
        item1: '🎨 Complete CSS refactoring - All 37 components refactored with design tokens (100% complete)',
        item2: '📋 Design token system - Created 100+ tokens (COLORS, SPACING, FONT_SIZE, FONT_WEIGHT, etc.)',
        item3: '🔧 Reusable style utilities - 50+ common style objects in common.ts',
        item4: '🎯 695+ hardcoded colors replaced with COLORS tokens',
        item5: '📏 1,232+ hardcoded spacing values replaced with SPACING tokens',
        item6: '✨ Improved consistency - All design values from centralized system',
        item7: '🔄 Theme-ready - Foundation for future dark/light theme switching',
        item8: '📚 Documentation - CSS_REFACTORING_PLAN.md with complete plan and statistics',
      },
    },
